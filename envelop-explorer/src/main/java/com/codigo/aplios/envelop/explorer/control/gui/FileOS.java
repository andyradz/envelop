package com.codigo.aplios.envelop.explorer.control.gui;
...
import com.codigo.aplios.envelop.explorer.domain.form.JForm;
import com.codigo.aplios.envelop.explorer.model.FileTableModel;
...
public class FileOS {
	...
	private void initialize() {
		...
		frmToolbox.setIconImage(
				Toolkit.getDefaultToolkit().getImage(
						FileOS.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Bold.png")));
		frmToolbox.setTitle("JExplorer ver. 1.0.0.0 beta");
		...
		gbc_pnlMain.gridx = 0;
		gbc_pnlMain.gridy = 0;
		frmToolbox.getContentPane().add(pnlMain, gbc_pnlMain);
		...
		btnNewButton_2.setIcon(
				new ImageIcon(FileOS.class.getResource("/com/sun/java/swing/plaf/windows/icons/Computer.gif")));
		...
		frmToolbox.setJMenuBar(menuBar);
		...
		mntmPionoweUoenie.addActionListener(new ActionListener() {
			@Override
...
class ActionExit extends AbstractAction implements WindowListener {
	...
	public ActionExit(JButton component, String text, String desc) {
		...
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke("Z"));
