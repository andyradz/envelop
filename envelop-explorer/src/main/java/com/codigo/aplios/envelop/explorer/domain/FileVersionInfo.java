 ...
 *
 * Code file  : FileVersionInfo.java
...
public class FileVersionInfo {
	interface Version extends Library {
		...
		public int VerQueryValueW(Pointer pBlock, String lpSubBlock, PointerByReference lplpBuffer,
	...
	public static void main(String[] args) throws IOException {
		...
		boolean FileInfoResult =
				Version.INSTANCE.GetFileVersionInfoW(
						"c:\\Windows\\bfsvc.exe",
						0,
						versionlength,
						lpData);
