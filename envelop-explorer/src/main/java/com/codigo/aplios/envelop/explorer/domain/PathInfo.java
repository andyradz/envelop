...
import com.codigo.aplios.envelop.explorer.control.IPathVisitor;
...
public abstract class PathInfo implements IPathInfo {
	...
	public LocalDateTime creationTime() {
		...
		try {
			...
			return LocalDateTime.ofInstant(pathAttr.creationTime().toInstant(), ZoneId.systemDefault());
		}
	...
	@Override
	public String name() {
		return this.pathName.toFile().getName().toString();
	}
	...
	public String fullName() {
		return this.pathName.toFile().getAbsolutePath().toString();
	}
	...
	public String localName() {
		return this.pathName.toFile().getPath();
	}
	...
	public boolean isRoot() {
		return FileSystemView.getFileSystemView().isFileSystemRoot(this.pathName.toFile());
	}
	...
	public boolean isDirectory() {
		return (this.pathName.toFile().isDirectory());
	}

	@Override
	public boolean isFile() {
		return (this.pathName.toFile().isFile());
	}
	...
	@Override
	public String label() {
		return FileSystemView.getFileSystemView().getSystemDisplayName(this.pathName.toFile());
	}
	...
	public LocalDateTime lastAccessTime() {
		...
		try {
			pathAttribute = Files.getFileAttributeView(this.pathName, BasicFileAttributeView.class).readAttributes();
			return LocalDateTime.ofInstant(pathAttribute.lastAccessTime().toInstant(), ZoneId.systemDefault());
		}
		catch (IOException ex) {
			Logger.getLogger(PathInfo.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public LocalDateTime lastWriteTime() {
		...
		try {
			pathAttribute = Files.getFileAttributeView(this.pathName, BasicFileAttributeView.class).readAttributes();
			return LocalDateTime.ofInstant(pathAttribute.lastModifiedTime().toInstant(), ZoneId.systemDefault());
		}
		catch (IOException ex) {
			Logger.getLogger(PathInfo.class.getName()).log(Level.SEVERE, null, ex);
		}
