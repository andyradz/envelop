...
import com.codigo.aplios.envelop.explorer.control.gui.sheet.render.FileNameTableCellRender;
import com.codigo.aplios.envelop.explorer.control.gui.sheet.render.ImageTableCellRender;
...
public class FileTableDemo {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        table.getColumnModel().getColumn(0).setCellRenderer(new ImageTableCellRender());
        table.getColumnModel().getColumn(1).setCellRenderer(new FileNameTableCellRender());
