...
class AttributiveCellTableModel extends DefaultTableModel {
	...
	public void setDataVector(Vector newData, Vector columnNames) {
		...
		newRowsAdded(new TableModelEvent(this, 0, getRowCount()
				- 1, TableModelEvent.ALL_COLUMNS, TableModelEvent.INSERT));
	}
	...
	public void addRow(Vector rowData) {
		...
		newRowsAdded(new TableModelEvent(this, getRowCount() - 1, getRowCount()
				- 1, TableModelEvent.ALL_COLUMNS, TableModelEvent.INSERT));
	}
...
class MultiSpanCellTableUI extends BasicTableUI {
	...
	public void paint(Graphics g, JComponent c) {
		...
		int tableWidth = table.getColumnModel()
				.getTotalColumnWidth();
	...
	private void paintCell(Graphics g, Rectangle cellRect, int row, int column) {
		...
		int spacingWidth = table.getColumnModel()
				.getColumnMargin();
