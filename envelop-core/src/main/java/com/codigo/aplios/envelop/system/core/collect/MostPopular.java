package com.codigo.aplios.envelop.system.core.collect;
...
public class MostPopular<T> implements Collector<T, Map<T, Integer>, Optional<T>> {
	...
	public static void main(String[] args) {
		...
		List<Integer> integers =
				Arrays.asList(1, 1, 2, 2, 2, 3, 4, 5, 5, 5, 5, 5, 5, 5, 34, 34, 34, 324, 4, 4, 422, 121, 23, 1, 1, 1, 1,
						1, 1, 1, 1, 1);
		List<Character> characters =
				Arrays.asList('a', 'b', 'c', 'c', 'c', 'd', 'a', 'b', 'c', 'c', 'c', 'd', 'a', 'b', 'c', 'c', 'c', 'd',
						'a', 'b', 'c', 'c', 'c', 'd');
