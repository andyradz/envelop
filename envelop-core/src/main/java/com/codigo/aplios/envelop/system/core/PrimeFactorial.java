...
Rozkład na czynniki pierwsze (ang. prime factorization) polega na znalezieniu dla danej liczby naturalnej n, n > 1, wszystkich liczb pierwszych,
których iloczyn daje n. Zadanie to można rozwiązać na kilka różnych sposobów, jednakże nie istnieje żaden prosty wzór,
który by pozwolił łatwo wyznaczać wszystkie czynniki pierwsze rozkładu - należy ich szukać. My podejdziemy do problemu w sposób następujący: 
*/
...
public class PrimeFactorial {
     ...
     * Realizuje też test rozkładu liczby na czynniki pierwsze
	 * @param args
	 */
	public static void main(String[] args) {		
		for (long idx = 1; idx <= 100_000_000; idx++)
		{
			Iterator<Long> iter = dissect(idx);
	...
	/**
	 * Metoda  realizuje rozkład liczby naturalnej na czynniki pierwsze.
	 * Zastosowano matematyczny algorytm rozkładu na czynniki pierwsze.
