package com.codigo.aplios.envelop.system.core.resource;
...
import com.codigo.aplios.envelop.system.core.resource.ResourceLoader.EnvironmentLevel.Bundle;



/**
 * Klasa realizuje mechanizm dostępu do elementów statycznych programu.
 * Umożliwia ładowanie zasobów typu napisy tekstowe, ikony, obrazy, konfiguracje, pliki binarne.
 * Zasoby podzielone są na grupy, które odpowiadają warstwą aplikacyjnym dostępnym w systemie.
 * 
 * @author Andrzej Radziszewski
 *         ar.radziszewski@gmail.com
...
public final class ResourceLoader {
	...
	enum EnvironmentLevel {
		...
		/**
		 * Metoda pobiera pakiet elementów statycznych z zasobu systemu. Dane zawarte w pakiecie
		 * dotyczą wskazanego poziomu aplikacji systemu.
		 * 
		 * @param indykator
		...
		public ResourceBundle getBundle(Bundle element) {
			...
			return EnumSet.of(element)
					...
					.findFirst()
					.orElse(null)
					.getContext(mEnvironmentLevel);
		}

		/*
		 * Typ wyliczeniowy definuje listę indykatorów, które przedstawiają obaszar elementów
		 * statycznych systemu.
		 */
		enum Bundle {
			...
			/**
			 * Metoda pobiera pakiet elementów statycznych z zasobu systemu. Dane zawarte w pakiecie
			 * dotyczą wskazanego poziomu środowiska systemu.
			 * 
...
class ImageBundle extends ListResourceBundle {
	...
	private Object[][] mImages = {
			{
					"PIC1",
					ResourceLoader.class.getResource("/development/images/pic1.jpg") },
			{
					"PIC2",
					ResourceLoader.class.getResource("/development/images/pic2.jpg") },
			{
					"PIC3",
					ResourceLoader.class.getResource("/development/images/pic3.jpg") },
			{
					"PIC4",
					ResourceLoader.class.getResource("/development/images/pic4.jpg") } };
}
