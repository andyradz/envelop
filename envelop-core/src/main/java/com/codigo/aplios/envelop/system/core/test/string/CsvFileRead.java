package com.codigo.aplios.envelop.system.core.test.string;
...
public class CsvFileRead {
	...
	private static void readStreamOfLinesUsingFilesWithTryBlock() throws IOException {
		...
		// "c://windows/csup.txt";
		String fileName = "C://Windows//content.xml";
	...
	public static String formatSize(long v) {
		...
		int z = (63
				...
				/ 10;
		return String.format("%.1f %sB", (double) v
				/ (1L << (z
						* 10)), " KMGTPE".charAt(z));
	}
}
